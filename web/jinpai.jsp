      ...
      <div class="parent" style="margin-top: 50px">
          ...
          <div class="main">
              ...
              <div class="layui-card" style="width: 730px; box-shadow: 0 0 0 0;">
                  ...
                  <div class="layui-card-body">
                  	<p>
    <input type="hidden" name="countDown" data-prefix="距离活动结束仅有" value="2019/12/01 22:30:27"> <span class="payment-time"><span class="active-time pull-right"><t class="time_prefix">距离活动结束仅有</t><em class="time_d">2</em>天<em class="time_h">07</em>:<em class="time_m">38</em>:<em class="time_s">07</em><t class="time_suffix"></t></span></span>
</p>
                      <form class="layui-form" action="" style="margin-left: -50px">
                          ...
                          <div class="layui-form-item">
                              <label class="layui-form-label">当&nbsp;&nbsp;&nbsp;&nbsp;前</label>
                              <div class="layui-input-block">
                                  <font size="6" color="red" >280</font>
                              </div>
                          </div>
                          <div class="layui-form-item">
                              ...
                              <div class="layui-input-block">
                                  ...
                                  <button class="layui-btn layui-btn-sm layui-bg-cyan">竞拍</button>
                              </div>
                          </div>
                      </form>
                  </div>
                  <div class="layui-card-body">
                      <a  class="layui-btn layui-bg-red" href="test4.jsp"  >加价10元</a>
                      <a  class="layui-btn layui-bg-red" href="test4.jsp"  >加价20元</a>
                      <a  class="layui-btn layui-bg-red" href="test4.jsp"  >加价30元</a>
                      <a  class="layui-btn layui-bg-red" href="test4.jsp"  >加价40元</a>
      ...
      <div class="layui-tab" style="margin-top: 50px">
          ...
          <div class="layui-tab-content">
              <div class="layui-tab-item layui-show">产品参数：
                  ...
                  产品名称：罗技G G403品牌: 罗技G型号: G403成色: 全新售后服务: 全国联保接口类型: USB按键数: 6个光学分辨率: 12000DPI工作方式: 光电颜色分类: G403有线版+赛事脚贴（套餐一） 罗技G403有线版+G240鼠标垫 罗技G403有线版+G440鼠标垫 罗技G403双模版 罗技G403+赛事脚贴 G403+游戏大桌垫 G403有线版+游戏鼠标垫（套餐二）套餐类型: 官方标配是否支持人体工程学:</div>
